...
Get_CurrentServer_address(mem){
    aPattern := mem.hexStringToPattern("00 00 ?? ?? ?? ?? ?? ?? 00 00 ?? ?? ?? ?? ?? ?? 00 00 ?? ?? ?? ?? ?? ?? 00 00 0B 00 00 00 04 00 00 00 02 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 ?? ?? ?? ?? ?? ?? 00 00 04 00 00 80 00 00 00 00 00 00 00 00 00 00 00 00")
    CurrentServer_address := mem.processPatternScan(,, aPattern*)  
    If (CurrentServer_address>0)
        CurrentServer_AddressBase := CurrentServer_address + 0x4A
...
Get_StaticTooltip_address(mem){
    aPattern := mem.hexStringToPattern("7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? 7F 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ?? 7F 00 00")
    StaticTooltip_address := mem.processPatternScan(,, aPattern*)
    If (StaticTooltip_address>0)
        StaticTooltip_addressBase := StaticTooltip_address + 0x6F
